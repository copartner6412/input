// Package validate provides utilities for validating various input formats.
package validate
...
var specialRunes []rune = []rune("!#$%&\"'()*+,-./:;<=>?@[\\]^_`{|}~")
var printableRunes []rune = []rune("!#$%&\"'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~") // 95 characters
